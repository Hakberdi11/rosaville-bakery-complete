    ...
    <div className="w-full">
      ...
      <section className="py-20 bg-[#FBF7F4]">
        <div className="container max-w-3xl text-center fade-in">
          <img 
            src="/manus-storage/rosaville-logo_45ed39e4.jpg" 
            alt="Rosaville Desserts Logo"
            className="h-32 w-auto mx-auto mb-8 rounded-lg shadow-md"
          />
          <h1 className="font-serif text-5xl md:text-6xl font-bold text-[#3D2817] mb-6">
            Our Story
          </h1>
          <p className="font-sans text-lg text-[#3D2817]/70">
      ...
      <section className="py-20 bg-[#FBF7F4]">
        <div className="container max-w-3xl">
          <div className="fade-in-up space-y-6">
            <p className="font-sans text-lg text-[#3D2817]/80 leading-relaxed">
            ...
            <p className="font-sans text-lg text-[#3D2817]/80 leading-relaxed">
              Every dessert we create carries the warmth of home, the care of handcrafted preparation, and the joy of sharing sweet moments with loved ones. We believe that desserts are more than just treats—they're memories in the making.
            </p>
            <p className="font-sans text-lg text-[#3D2817]/80 leading-relaxed">
              From our family to yours, each cake, pastry, and cookie is made with the finest ingredients and a whole lot of love. We're committed to creating an experience that feels personal, welcoming, and unforgettably delicious.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#FBF7F4]">
        <div className="container">
          <h2 className="font-serif text-4xl font-bold text-[#3D2817] text-center mb-16 fade-in">
            Our Values
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={idx}
                className="fade-in-up p-6 rounded-xl border border-[#E8B4B8] hover:border-[#E8B4B8] hover:bg-[#FBF7F4] transition-all"
                style={{ animationDelay: `${idx * 50}ms` }}
              >
                <h3 className="font-serif text-xl font-semibold text-[#3D2817] mb-3">
                  {value.title}
                </h3>
                <p className="font-sans text-[#3D2817]/70">
                  {value.description}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              >
                ...
                <h3 className="font-serif text-xl font-semibold text-[#3D2817] mb-1">
                  {member.name}
                </h3>
                <p className="font-sans text-sm text-[#E8B4B8] font-semibold mb-3">
                  {member.role}
                </p>
                <p className="font-sans text-[#3D2817]/70">
                  {member.bio}
